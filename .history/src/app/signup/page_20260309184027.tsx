    ...
    <main className="flex min-h-screen items-center justify-center bg-gray-50 dark:bg-black p-6">
      ...
      <div className="w-full max-w-md rounded-2xl bg-white dark:bg-neutral-900 shadow-xl p-8 space-y-6">
        ...
        <div className="space-y-3">
          ...
          <button onClick={() => signIn("google")} className="flex items-center justify-center gap-3 w-full border rounded-lg py-3 hover:bg-gray-50 dark:hover:bg-neutral-800 transition">
          ...
          <button onClick={() => signIn("facebook")} className="flex items-center justify-center gap-3 w-full border rounded-lg py-3 hover:bg-gray-50 dark:hover:bg-neutral-800 transition">

            {/* Facebook Icon */}
            <svg width="18" height="18" viewBox="0 0 24 24" fill="#1877F2">
              <path d="M22 12a10 10 0 1 0-11.56 9.87v-6.99h-2.2V12h2.2V9.8c0-2.18 1.3-3.39 3.3-3.39.96 0 1.96.17 1.96.17v2.15h-1.1c-1.09 0-1.43.68-1.43 1.38V12h2.44l-.39 2.88h-2.05v6.99A10 10 0 0 0 22 12z"/>
            </svg>
